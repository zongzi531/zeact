...
var TodoItem = Zzeact.createClass({
  handleSubmit: Zzeact.autoBind(function () {
  ...
  handleEdit: Zzeact.autoBind(function () {
    this.props.onEdit();
    this.refs.editField.getDOMNode().focus();
  }),
  handleKey: Zzeact.autoBind(function (event) {
...
var TodoFooter = Zzeact.createClass({
  render: function () {
...
var TodoApp = Zzeact.createClass({
  getInitialState: function () {
    return {
...
Zzeact.renderComponent(<TodoApp />, document.getElementById('todoapp'));
